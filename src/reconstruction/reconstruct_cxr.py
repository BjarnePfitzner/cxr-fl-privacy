...
if read_init_model:
    init_model_path = '../cxr-fl-privacy/output_all_chexpert_clients/global_0rounds.pth.tar'
if read_trained_model:
    trained_model_path = '../cxr-fl-privacy/output_all_chexpert_clients/round1_client19/1-epoch_FL.pth.tar'
...
if read_trained_model:
    ...
    img_label = [0]
    client_file_path = '../cxr-fl-privacy/data/chexpert_clients/client_19/'
    img_data_path = '/dhc/dsets/ChestXrays/CheXpert/'
...
if __name__ == "__main__":
    ...
    if args.model == 'ResNet152':
        ...
        model_seed = None
        if label_encoding == 'multi':
            model = custom_models.ResNet(out_size=num_classes, colour_input=colour_input, pre_trained=args.trained_model)
        else:
